...
<!-- Title: Contributing GithubFlow GHQProjectManager -->
...
To contribute to ghq-project-manager project on [GitHub](https://github.com/hadenlabs/ghq-project-manager), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/ghq-project-manager/pulls).
...
To follow the instructions in this guide and start contributing to ghq-project-manager project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/ghq-project-manager.git
```

Now your **upstream** points to **hadenlabs/ghq-project-manager**.
...
git fetch upstream # assuming upstream is hadenlabs/ghq-project-manager
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/ghq-project-manager/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
